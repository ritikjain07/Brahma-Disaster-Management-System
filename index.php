...
if (file_exists('database/config_simple.php')) {
    require_once 'database/config_simple.php';
}
?>
...
<body class="bg-gray-100 flex flex-col items-center justify-start min-h-screen">
  ...
  <div class="fixed-nav">
    <div class="nav-items">
      <div class="logo">
        <img src="assets/images/logo_brahma.png" alt="Logo" class="h-14">
  ...
  <div id="sidebar" class="sidebar">
    <ul>
      ...
      <li><a href="pages/about-page.php">About</a></li>
      <li><a href="pages/service-page.php">Services</a></li>
      <li><a href="pages/contact-page.php">Contact</a></li>
      <li><a href="pages/donation2.php">Donation</a></li>
      <li><a href="pages/view_missing_person.php">View Missing Person</a></li>
      <li><a href="pages/missing_person.php">Report a missing person</a></li>
  ...
  <div class="hero flex flex-col items-center justify-center text-center w-full text-white">
    ...
    <div class="mt-8 flex flex-col items-center">
      ...
      <div class="mt-12 flex flex-col space-y-4">
        <a href="pages/emergencyForm.php" class="w-48 h-12 rounded-full text-white flex justify-center items-center text-xl font-bold shadow-2xl bg-blue-500 hover:bg-blue-600 transition">Emergency</a>
        <a href="pages/evacuation.php" class="w-48 h-12 rounded-full text-white flex justify-center items-center text-xl font-bold shadow-2xl bg-yellow-500 hover:bg-yellow-600 transition">Evacuation</a>
        <a href="pages/missing_person.php" class="w-48 h-12 rounded-full text-white flex justify-center items-center text-l font-bold shadow-2xl bg-red-500 hover:bg-red-600 transition">Report Missing Person</a>
        <a href="pages/survival_tips.php" class="w-48 h-12 rounded-full text-white flex justify-center items-center text-xl font-bold shadow-2xl bg-green-500 hover:bg-green-600 transition">Survival tips</a>
      </div>
    </div>
  </div>
  ...
  <div class="w-full flex justify-center mt-8">
    <a href="pages/weatherForcast.php" class="w-48 h-12 rounded-full text-white flex justify-center items-center text-xl font-bold shadow-2xl bg-blue-500 hover:bg-red-600 transition">Weather Forecast</a>
  </div>
  ...
  <div class="w-full flex justify-center mt-12 mb-12">
    <div class="w-full max-w-4xl bg-black p-6 rounded-lg text-center text-white">
      ...
      <a href="pages/donation2.php" class="bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-600 transition duration-300">Donate Now</a>
    </div>
  </div>

  <script>
    document.getElementById('sosButton').addEventListener('click', function() {
      window.location.href = 'pages/helpForm.php';
    });
